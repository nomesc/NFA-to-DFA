/*
 *
 * Fisierul de intrare "date.out" trebuie sa contina:
 *
 * Numar litere alfabet
 *
 * Ex:2
 *
 * alfabetul litere lelegate
 *
 * Ex:ab
 *
 * numar stari
 ...
 * Ex:0 2
 *
 * (Numar Elemente In Stare) (Elementele) (Prima Litera Alfabet) (Spre Cate Stari Pleaca) (Starile) (La fel Pentru Restul Literelor Din Alfabet)
 * (La fel Pentru Restul Starilor Din Automat)
 *
 * !!Prima Stare scrisa este considerata de intrare
 *
 * Ex
 *  1 0     a 1 1           b 2 0 3
 ...
 * Ex
 *  1 3     a 0             b 1 0
 *  Din starea q3 pleaca 'a' spre nimeni si 'b' spre q0
 *  /////////
 * Ex
 *  1 4     a 3 0 2 3       b 0
